...
file.names = c("Data_Codes/Light/TIK2/TIK2-20-light.csv","Data_Codes/Light/TIK2/TIK2-40-light.csv","Data_Codes/Light/TIK2/TIK2-60-light.csv","Data_Codes/Light/TIK2/TIK2-90-light.csv","Data_Codes/Light/TIK2/TIK2-120-light.csv")
prof = c(20,40,60,90,120)
df_all=data.frame()

# Introduce limits of time, to get to the depth and to take it out. 
# Date_Time initial >> "2018-10-20 13:00:00"
# Date_Time final >>  "2018-10-24 13:45:00"
...
for(x in 1:length(file.names)){
  ...
  df <- subset(df, Date_Time > "2018-10-20 13:00:00" & Date_Time < "2018-10-24 13:45:00")
  df$Depth <- prof[x]
...
write.csv(df_all, "Data_Codes/Light/TIK2/TIK2_Light_data.csv")
...
Index_light$Id_Site <- "TIK2"
Index_light$Archipelago <- "Tuamotu"
Index_light$Island <- "Tikehau"
Index_light$Site <- "2"
...
write.csv (Index_light_Loss, paste("Data_Codes/Light/TIK2/", Id_Site,"_", "Index_Light_loss.csv", sep = ""))
